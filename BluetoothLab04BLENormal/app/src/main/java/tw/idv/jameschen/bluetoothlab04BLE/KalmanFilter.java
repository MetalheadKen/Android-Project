...
public class KalmanFilter {
    ...
    public static final double COVARIANCE_R = 1e-1;

    //private static final Map<String, Double> mPreSignals = new HashMap<String, Double>();
    //private static final Map<String, Double> mPreErrorCovariances = new HashMap<String, Double>();
