...
public class RoutePlanningActivity extends Activity implements View.OnClickListener, SensorEventListener {
    ...
    private IBeaconActivity iBeaconActivity = new IBeaconActivity();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iBeaconActivity.Initialize();
       // iBeaconActivity.doScanBleDevices();
    }
    ...
    public void onClick(View v) {
        new Thread() {
            public void run() {
                ...
                try {
                    bw.write(/*iBeaconActivity.origin_coordinate + */" " + GetArrayIndex(destination) + "\n");
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    public void onPause() {
        ...
        //iBeaconActivity.cancelScanBluetoothDevices();
    }
