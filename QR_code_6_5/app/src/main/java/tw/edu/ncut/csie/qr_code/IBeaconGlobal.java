...
public class IBeaconGlobal {
    ...
    public static String beacon_uuid_url = "http://140.128.88.166:8080/PushNotification.php?ctrl=2";
    public static String beacon_mac_address_url = "http://140.128.88.166:8080/PushNotification.php?ctrl=1";
    public static String product_information_url = "http://140.128.88.166:8080/PushSprice.php";
}
